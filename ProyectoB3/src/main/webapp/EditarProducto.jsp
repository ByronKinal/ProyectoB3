        ...
        <div class="card">
            ...
            <form action="ListarProductos.jsp" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="idCategoria" name="idCategoria" value="${producto.categoria.idCategoria}" required min="1">
                </div>

                <div class="form-group">
                    <label class="card-label" for="idProveedor">ID Proveedor</label>
                    <input type="number" id="idProveedor" name="idProveedor" value="${producto.proveedor.idProveedor}" required min="1">
                </div>

                <div class="form-buttons">
                    <button type="submit" class="btn-actualizar">Actualizar Producto</button>
                    <button type="button" class="btn-cancelar" onclick="window.location.href = 'ListarProductos.jsp'">Cancelar</button>
                </div>
            </form>
        </div>
