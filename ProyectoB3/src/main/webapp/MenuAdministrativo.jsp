<%-- 
    ...
    Created on : Jul 29, 2025, 9:18:06 PM
    Author     : mario.garcia
--%>
...
<html>
    ...
    <body>
        ...
        <div class="menu">
            ...
            <a class="btnCambios" id="agregar" href="RegistroProductos.jsp">AGREGAR</a>
        </div>
        ...
        <div class="galeria">
            <div class="producto">
                <img src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/1fa18f47b66e4f4980ba74d48de04ecc_9366/Handball_Spezial_Shoes_Blue_IF7087_01_standard.jpg"
                     alt="Producto 1">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
                </div>
            </div>
            ...
            <div class="producto">
                <img src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/u_126ab356-44d8-4a06-89b4-fcdcc8df0245,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/ab8d8bb7-536e-43af-8f49-5d86c370b7a2/AIR+JORDAN+1+MID.png"
                     alt="Producto 9">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/u_126ab356-44d8-4a06-89b4-fcdcc8df0245,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/dcbc35ce-491e-4f61-b2ca-4da4a5c1a431/AIR+JORDAN+1+LOW+SE.png"
                     alt="Producto 10">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/9421d8988fdb4e79aa8a439b2b05043a_9366/Forum_Low_CL_Shoes_White_JQ0207_01_00_standard.jpg"
                     alt="Producto 11">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/763fb5a2d82d448ca62baf4600f657c6_9366/Gazelle_Bold_Shoes_Black_HQ6912_01_00_standard.jpg"
                     alt="Producto 12">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/u_126ab356-44d8-4a06-89b4-fcdcc8df0245,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/9c3a7c72-9740-4b33-8d4b-194c6492faf1/AIR+JORDAN+1+LOW+EASYON.png"
                     alt="Producto 13">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_500,h_500/global/395205/02/sv01/fnd/PNA/fmt/png/Tenis-Suede-XL"
                     alt="Producto 14">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_500,h_500/global/395205/03/sv01/fnd/PNA/fmt/png/Tenis-Suede-XL"
                     alt="Producto 15">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/u_126ab356-44d8-4a06-89b4-fcdcc8df0245,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/89235dab-3047-41d2-af7b-d0a77f43fe6a/AIR+JORDAN+1+HIGH+G.png"
                     alt="Producto 16">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_500,h_500/global/402869/01/sv01/fnd/PNA/fmt/png/Inhale-Tech-Street-X-Sneakers-Unisex"
                     alt="Producto 16">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_500,h_500/global/405719/01/sv01/fnd/PNA/fmt/png/GV-Special-Tailored-Stripes-Sneakers-Unisex"
                     alt="Producto 16">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
            ...
            <div class="producto">
                <img src="https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/c2ff02abbd304144b45797e8408f581a_9366/Gazelle_Indoor_Shoes_Blue_JI2061_01_standard.jpg"
                     alt="Producto 16">
                <div class="info">
                    <a class="btnCambios" id="editar" href="RegistroProductos.jsp"> EDITAR</a>
                    <button  class="btnCambios" id="eliminar">ELIMINAR</button>
